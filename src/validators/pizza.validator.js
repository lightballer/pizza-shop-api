module.exports = data => {
  ...
  if (!price_small) throw new Error('price_small is required');
  if (typeof price_small !== 'number')
    throw new Error('price_small should be a number');

  if (!price_medium) throw new Error('price_medium is required');
  if (typeof price_medium !== 'number')
    throw new Error('price_medium should be a number');

  if (!price_large) throw new Error('price_large is required');
